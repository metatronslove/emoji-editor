...
async function loadConversations() {
    try {
        const response = await fetch(SITE_BASE_URL + 'core/get_conversations.php');
...
async function loadMediaGallery() {
    try {
        ...
        const response = await fetch(SITE_BASE_URL + 'core/fetch_user_media.php');
        const result = await response.json();
...
async function markMessagesAsRead(otherUserId) {
    try {
        await fetch(SITE_BASE_URL + 'core/mark_messages_read.php', {
            method: 'POST',
            headers: {
